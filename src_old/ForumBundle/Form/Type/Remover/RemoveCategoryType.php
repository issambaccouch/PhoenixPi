<?php
namespace ForumBundle\Form\Type\Remover;
...
class RemoveCategoryType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('purge', CheckboxType::class, array(
                'label'    => 'forum.category.removeall.label',
                'required' => false,
            ))
        ;
    }
    ...
    private function getAllCategories() {
        $categories = $this->em->getRepository('ForumBundle:Category')->findBy(array(), array('position' => 'asc', ));
