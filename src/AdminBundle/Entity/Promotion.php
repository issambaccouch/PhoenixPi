...
class Promotion
{
     ...
     * Set idpr
     *
     * @param \AdminBundle\Entity\Produit $idpr
     *
     * @return Promotion
     */
    public function setIdpr(\AdminBundle\Entity\Produit $idpr = null)
    {
        $this->idpr = $idpr;
     ...
     * Set idcp
     *
     * @param \AdminBundle\Entity\Categorieprod $idcp
     *
     * @return Promotion
     */
    public function setIdcp(\AdminBundle\Entity\Categorieprod $idcp = null)
    {
        $this->idcp = $idcp;
     ...
     * Get idcp
     *
     * @return \AdminBundle\Entity\Categorieprod
     */
